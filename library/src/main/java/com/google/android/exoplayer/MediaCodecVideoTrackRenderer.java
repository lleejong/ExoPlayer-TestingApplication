...
public class MediaCodecVideoTrackRenderer extends MediaCodecTrackRenderer {
  ...
  public interface EventListener extends MediaCodecTrackRenderer.EventListener {
    ...
    void onVideoSizeChanged(int width, int height, int unappliedRotationDegrees,
        float pixelWidthHeightRatio, long elapsedTime);
  ...
  protected void onStarted() {
    ...
    droppedFrameAccumulationStartTimeMs = startTime;
  }
    ...
    eventHandler.post(new Runnable()  {
      ...
      public void run() {
        eventListener.onVideoSizeChanged(currentWidth, currentHeight,
            currentUnappliedRotationDegrees, currentPixelWidthHeightRatio, time);
      }
    });
